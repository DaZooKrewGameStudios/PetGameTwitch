...
#include "ShibatanTwitchComponent.h"
#include "TwitchSDK.h"
#include "Engine.h"
// Sets default values for this component's properties
UShibatanShibatanTwitchComponent::UShibatanShibatanTwitchComponent()
{
...
void UShibatanShibatanTwitchComponent::BeginPlay()
{
	Super::BeginPlay();
	...
	auto rewardHandler = [this](const TwitchSDK::CustomRewardEvent& e)
	{
		...
		if (bDebug)
		{
			...
			//auto message = FString::Printf(TEXT("Reward on %s! Level: %d, Total Points: %lld", *BroadcasterName, e.CustomRewardTitle, e.CustomRewardCost));
...
// Called every frame
void UShibatanShibatanTwitchComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
TwitchSDK::CustomRewardEvent UShibatanShibatanTwitchComponent::handleCustomRewardEvent(
